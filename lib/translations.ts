...
export const t = {
    ...
    items: [
      {
        ...
        desc:    { id: 'Pemasangan sensor di mesin lama, koneksi ke internet, dan monitoring real-time.',
                   en: 'Install sensors on legacy machines, connect to the internet, and enable real-time monitoring.' },
        example: { id: 'Tarik data suhu & getaran mesin produksi ke dashboard online.',
      ...
      },
      {
        ...
        desc:    { id: 'Pengembangan IoT & AI khusus sesuai dengan masalah operasional spesifik di pabrik Anda.',
                   en: 'Custom IoT & AI development tailored to specific operational problems in your factory.' },
        example: { id: 'Solusi end-to-end yang dirancang eksklusif berdasarkan kebutuhan unik.',
  ...
  socialProof: {
    ...
    projects: [
      {
        client: 'Toyota',
        desc:   { id: 'Monitoring IoT real-time untuk equipment di lini produksi.',
                  en: 'Real-time IoT monitoring for equipment on the production line.' },
      },
      {
        client: 'PT GAP (Erlangga)',
        desc:   { id: 'Digitalisasi proses operasional pabrik.',
  ...
  whyIchibot: {
    ...
    items: [
      ...
      },
      {
        ...
        desc:  { id: 'Dipasang di mesin existing tanpa perlu ganti infrastruktur atau hentikan produksi.',
                 en: 'Installed on existing machines without replacing infrastructure or stopping production.' },
      },
      {
        title: { id: 'Fleksibel',     en: 'Flexible' },
        desc:  { id: 'Dari full-service implementation sampai training agar tim Anda bisa mandiri.',
                 en: 'From full-service implementation to training so your team becomes self-sufficient.' },
      },
      {
        title: { id: 'Terbukti',      en: 'Proven' },
        desc:  { id: 'Dipercaya Toyota, Pertamina, BCA, dan perusahaan enterprise Indonesia.',
                 en: 'Trusted by Toyota, Pertamina, BCA, and Indonesian enterprise companies.' },
      },
      {
        title: { id: 'Mendukung Net Zero',  en: 'Net Zero Friendly' },
        desc:  { id: 'Tidak ada mesin lama yang dibuang, tidak ada produksi hardware baru. Digitalisasi Ichibot bekerja di atas infrastruktur yang sudah ada — lebih efisien, lebih hijau.',
    ...
    posts: [
      {
        ...
        category: 'IoT',
        title:   { id: 'IoT untuk Mesin Lama: Mulai dari Mana?',
                   en: 'IoT for Legacy Machines: Where to Start?' },
        excerpt: { id: 'Sebagian besar pabrik di Indonesia masih menggunakan mesin lama yang tidak terhubung ke internet. Berikut cara kami mendekati masalah ini.',
      ...
      },
      {
        ...
        category: 'AI',
        title:   { id: 'Computer Vision untuk Quality Control: Studi Kasus Lini Produksi',
                   en: 'Computer Vision for Quality Control: Production Line Case Study' },
        excerpt: { id: 'Bagaimana kamera AI mampu mendeteksi cacat produk 10x lebih cepat dari inspektur manusia — dan apa trade-off-nya.',
      ...
      },
      {
        ...
        category: 'Case Study',
        title:   { id: 'Menghitung ROI Digitalisasi Pabrik: Panduan Praktis',
                   en: 'Calculating Factory Digitalization ROI: A Practical Guide' },
        excerpt: { id: 'Sebelum investasi di IoT dan AI, penting untuk menghitung potensi ROI secara realistis. Kami bagikan framework yang kami gunakan bersama klien.',
...
export const WHATSAPP_NUMBER = '6281234567890' // placeholder — ganti nanti
